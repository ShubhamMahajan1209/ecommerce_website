...
<body>
    ...
    <section class="container sproduct my-5 pt-5">
        <div class="row">
            <div class="col-lg-5">
                <img src="D:\Webtech_Project\products\sports\sports_badminton.jpg" alt="" class="w-100">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home/Badmin.../1003</h6>
                <h3 class="py-4">Badminton Set</h3>
                <h2>$139.00</h2>
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>Elevate your game with our state-of-the-art badminton racket, engineered for speed, agility, and control. Designed with precision and crafted from high-quality materials, it allows players to execute swift and powerful shots with ease. Its lightweight yet sturdy construction reduces fatigue during intense rallies, ensuring peak performance from start to finish. Whether you're a beginner or a seasoned pro, our badminton racket is your ultimate companion for dominating the court and outplaying your <br></span>
